package com.example.dingdangpocket.example.painting;
...
public class PaintingActivity extends AppCompatActivity implements View.OnClickListener, PaletteView.Callback,Handler.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tb = findViewById(R.id.toolbar_painting);
            ...
            case R.id.painting_save:
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (savedFile != null) {
                            scanFile(PaintingActivity.this, savedFile);
